...
const DispenserScreen = () => {
  ...
  return (
    <ImageBackground source={require('../Images/FondoProfilEmployee.png')} style={styles.background}>
      ...
      <Text style={styles.TitleText}>ZooDispenser</Text>
      <TextInput style={styles.input} placeholder="Specie" placeholderTextColor="#000" />
      <TextInput style={styles.input} placeholder="Feeding Time" placeholderTextColor="#000" />
      <TextInput style={styles.input} placeholder="Food Amount (g)" placeholderTextColor="#000" />
