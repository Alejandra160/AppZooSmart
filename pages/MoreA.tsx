...
type AquaticZoneScreenRouteProp = RouteProp<{ params: { id: string } }, 'params'>;

const AquaticZoneScreen = () => {
  const navigation = useNavigation();
  const route = useRoute<AquaticZoneScreenRouteProp>();
  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollViewContent}>
      <ImageBackground source={require('../Images/AquaticFondo.png')} style={styles.background}>
        <TouchableOpacity style={styles.backButton} onPress={() => navigation.goBack()}>
          <Text style={styles.backButtonText}>BACK</Text>
        </TouchableOpacity>
        <Text style={styles.title}>AQUATIC ZONE</Text>
...
export default AquaticZoneScreen;
