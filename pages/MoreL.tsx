...
type LandZoneScreenRouteProp = RouteProp<{ params: { id: string } }, 'params'>;

const LandZoneScreen = () => {
  const navigation = useNavigation();
  const route = useRoute<LandZoneScreenRouteProp>();
  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollViewContent}>
      <ImageBackground source={require('../Images/LandFondo.png')} style={styles.background}>
        ...
        <Text style={styles.title}>LAND ZONE</Text>
